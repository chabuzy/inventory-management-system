...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Add Supplier Form </div>
    <div class="ps-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	<a class="dropdown-item" href="{{ route('supplier.all') }}">Supplier List</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            <div class="col-sm-3">
                                <h6 class="mb-0"> Supplier Mobile No </h6>
                            </div>
                            <div class="form-group col-sm-9 text-secondary">
                       ...
                       <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="submit" class="btn btn-primary px-4" value="Add Supplier" />
                            </div>
                        </div>
                        </form>
                    </div>
