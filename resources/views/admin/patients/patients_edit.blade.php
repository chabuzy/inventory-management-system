                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="number" name="mobile_no" value="{{ $customers->mobile_no }}"   class="form-control"  />
                                 @error('mobile_no')
                                  <span class="text-danger"> {{ $message }} </span>
                                 @enderror
                            </div>
                       ...
                       <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <img id="ShowImage" src="{{ asset($customers->customer_image) }}" alt="Admin"class="rounded-circle p-1 bg-primary" width="110">
                       ...
                       <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="submit" class="btn btn-primary px-4" value="Update Patients Data" />
                            </div>
                        </div>
                        </form>
                    </div>
