                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" name="blog_tags"  value="home,tech" data-role="tagsinput" class="form-control"  />
                                 @error('blog_tags')
                                  <span class="text-danger"> {{ $message }} </span>
                                 @enderror
                            </div>
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                 <textarea id="mytextarea" name="blog_description"></textarea>
                            </div>
                        </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="submit" class="btn btn-primary px-4" value="Insert Blog Data" />
                            </div>
                        </div>
                        </form>
                    </div>
