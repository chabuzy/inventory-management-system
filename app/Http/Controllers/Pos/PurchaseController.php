...
class PurchaseController extends Controller
{
    ...
    public function PurchaseAdd(){
        ...
        return 
        view('backend.purchase.purchase_add',compact('supplier','unit','category'));

    } // End Method 

     public function PurchaseAdd1(){

        $supplier = Supplier::all();
        $unit = Unit::all();
        $category = Category::all();
        return 
        view('backend.purchase.purchase_add1',compact('supplier','unit','category'));
